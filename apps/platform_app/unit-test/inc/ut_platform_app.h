 ...
 *
 * Purpose:
 * Extra scaffolding functions for the platform unit test
 *
 * Notes:
...
#ifndef UT_PLATFORM_APP_H
#define UT_PLATFORM_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "PLATFORM_APP_Data_t" typedef.
 */
#include "platform_app_events.h"
#include "platform_app.h"

/*
 * Allow UT access to the global "PLATFORM_APP_Data" object.
 */
extern PLATFORM_APP_Data_t PLATFORM_APP_Data;

#endif /* UT_PLATFORM_APP_H */
