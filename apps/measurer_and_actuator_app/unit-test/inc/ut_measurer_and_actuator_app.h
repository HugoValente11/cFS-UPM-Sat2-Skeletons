 ...
 *
 * Purpose:
 * Extra scaffolding functions for the measurer_and_actuator unit test
 *
 * Notes:
...
#ifndef UT_MEASURER_AND_ACTUATOR_APP_H
#define UT_MEASURER_AND_ACTUATOR_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "MEASURER_AND_ACTUATOR_APP_Data_t" typedef.
 */
#include "measurer_and_actuator_app_events.h"
#include "measurer_and_actuator_app.h"

/*
 * Allow UT access to the global "MEASURER_AND_ACTUATOR_APP_Data" object.
 */
extern MEASURER_AND_ACTUATOR_APP_Data_t MEASURER_AND_ACTUATOR_APP_Data;

#endif /* UT_MEASURER_AND_ACTUATOR_APP_H */
