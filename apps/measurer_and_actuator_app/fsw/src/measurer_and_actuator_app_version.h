...
#define MEASURER_AND_ACTUATOR_BUILD_NUMBER 73 /*!< Development Build: Number of commits since baseline */
...
#define MEASURER_AND_ACTUATOR_STR_HELPER(x) #x /*!< @brief Helper function to concatenate strings from integer macros */
#define MEASURER_AND_ACTUATOR_STR(x) \
    MEASURER_AND_ACTUATOR_STR_HELPER(x) /*!< @brief Helper function to concatenate strings from integer macros */

/*! @brief Development Build Version Number.
 * @details Baseline git tag + Number of commits since baseline. @n
 * See @ref cfsversions for format differences between development and release versions.
 */
#define MEASURER_AND_ACTUATOR_VERSION MEASURER_AND_ACTUATOR_BUILD_BASELINE "+dev" MEASURER_AND_ACTUATOR_STR(MEASURER_AND_ACTUATOR_BUILD_NUMBER)
...
#define MEASURER_AND_ACTUATOR_VERSION_STRING                       \
    " Sample App DEVELOPMENT BUILD " MEASURER_AND_ACTUATOR_VERSION \
