...
void MEASURER_AND_ACTUATOR_Send_MGT_Data(void);


void MEASURER_AND_ACTUATOR_Send_Step_In(void);
void MEASURER_AND_ACTUATOR_Receive_MGM_Data(void);


void MEASURER_AND_ACTUATOR_Receive_Step_Out(void);
