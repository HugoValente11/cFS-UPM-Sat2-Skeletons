 ...
 *
 * Purpose:
 * Extra scaffolding functions for the acs_hw unit test
 *
 * Notes:
...
#ifndef UT_ACS_HW_APP_H
#define UT_ACS_HW_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "ACS_HW_APP_Data_t" typedef.
 */
#include "acs_hw_app_events.h"
#include "acs_hw_app.h"

/*
 * Allow UT access to the global "ACS_HW_APP_Data" object.
 */
extern ACS_HW_APP_Data_t ACS_HW_APP_Data;

#endif /* UT_ACS_HW_APP_H */
