 ...
 *
 * Purpose:
 * Extra scaffolding functions for the storage unit test
 *
 * Notes:
...
#ifndef UT_STORAGE_APP_H
#define UT_STORAGE_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "STORAGE_APP_Data_t" typedef.
 */
#include "storage_app_events.h"
#include "storage_app.h"

/*
 * Allow UT access to the global "STORAGE_APP_Data" object.
 */
extern STORAGE_APP_Data_t STORAGE_APP_Data;

#endif /* UT_STORAGE_APP_H */
