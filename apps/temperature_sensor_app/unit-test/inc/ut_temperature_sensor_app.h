 ...
 *
 * Purpose:
 * Extra scaffolding functions for the temperature_sensor unit test
 *
 * Notes:
...
#ifndef UT_TEMPERATURE_SENSOR_APP_H
#define UT_TEMPERATURE_SENSOR_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "TEMPERATURE_SENSOR_APP_Data_t" typedef.
 */
#include "temperature_sensor_app_events.h"
#include "temperature_sensor_app.h"

/*
 * Allow UT access to the global "TEMPERATURE_SENSOR_APP_Data" object.
 */
extern TEMPERATURE_SENSOR_APP_Data_t TEMPERATURE_SENSOR_APP_Data;

#endif /* UT_TEMPERATURE_SENSOR_APP_H */
