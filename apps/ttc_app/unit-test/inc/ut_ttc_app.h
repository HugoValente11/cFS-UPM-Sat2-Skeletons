 ...
 *
 * Purpose:
 * Extra scaffolding functions for the ttc unit test
 *
 * Notes:
 ...
 * "TTC_APP_Data_t" typedef.
 */
#include "ttc_app_events.h"
#include "ttc_app.h"

/*
 * Allow UT access to the global "TTC_APP_Data" object.
 */
extern TTC_APP_Data_t TTC_APP_Data;
