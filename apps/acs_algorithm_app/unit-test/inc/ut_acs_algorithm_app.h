 ...
 *
 * Purpose:
 * Extra scaffolding functions for the acs_algorithm unit test
 *
 * Notes:
...
#ifndef UT_ACS_ALGORITHM_APP_H
#define UT_ACS_ALGORITHM_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "ACS_ALGORITHM_APP_Data_t" typedef.
 */
#include "acs_algorithm_app_events.h"
#include "acs_algorithm_app.h"

/*
 * Allow UT access to the global "ACS_ALGORITHM_APP_Data" object.
 */
extern ACS_ALGORITHM_APP_Data_t ACS_ALGORITHM_APP_Data;

#endif /* UT_ACS_ALGORITHM_APP_H */
