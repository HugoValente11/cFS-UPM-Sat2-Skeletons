...
typedef struct
{
    ...
    */
    ...
    // ASN structs
    asn1SccMyInteger IN_pStepIn;
    asn1SccMyInteger OUT_pStepOut;


    CFE_EVS_BinFilter_t EventFilters[ACS_ALGORITHM_EVENT_COUNTS];

} ACS_ALGORITHM_Data_t;
...
void ACS_ALGORITHM_Send_Step_Out(void);
void ACS_ALGORITHM_Receive_Step_In(void);
