 ...
 *
 * Purpose:
 * Extra scaffolding functions for the manager unit test
 *
 * Notes:
...
#ifndef UT_MANAGER_APP_H
#define UT_MANAGER_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "MANAGER_APP_Data_t" typedef.
 */
#include "manager_app_events.h"
#include "manager_app.h"

/*
 * Allow UT access to the global "MANAGER_APP_Data" object.
 */
extern MANAGER_APP_Data_t MANAGER_APP_Data;

#endif /* UT_MANAGER_APP_H */
