 ...
 *
 * Purpose:
 * Extra scaffolding functions for the pressure_sensor unit test
 *
 * Notes:
...
#ifndef UT_PRESSURE_SENSOR_APP_H
#define UT_PRESSURE_SENSOR_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "PRESSURE_SENSOR_APP_Data_t" typedef.
 */
#include "pressure_sensor_app_events.h"
#include "pressure_sensor_app.h"

/*
 * Allow UT access to the global "PRESSURE_SENSOR_APP_Data" object.
 */
extern PRESSURE_SENSOR_APP_Data_t PRESSURE_SENSOR_APP_Data;

#endif /* UT_PRESSURE_SENSOR_APP_H */
